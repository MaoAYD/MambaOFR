...
def degradation_video_list_5(video_list, degree=1, texture_url='./noise_data'):  ## Add moving lines
    ...
    distortion_types = ['blur', 'noise', 'jpeg', 'downsample']
    distortion_sequence = np.random.permutation(len(distortion_types))
    distortion_degree1 = {'type_value': random.random(), 'l1_value': random.random(), 'l2_value': random.random(),
                         'angle_value': random.random(), 'shape_value': random.randint(2, 5),
                         'noise_std': random.uniform(5.0 / 255., 6.0 / 255.), 'jpeg_quality': random.randint(80, 100),
                         'rnum': np.random.rand(), 'up_scale': random.uniform(1, 1.5),
                         'down_scale': random.uniform(0.5, 1)}
    distortion_degree2 = {'type_value': random.random(), 'l1_value': random.random(), 'l2_value': random.random(),
                         'angle_value': random.random(), 'shape_value': random.randint(5, 8),
                         'noise_std': random.uniform(6.0 / 255., 8.0 / 255.), 'jpeg_quality': random.randint(60, 80),
                         'rnum': np.random.rand(), 'up_scale': random.uniform(1, 2),
                         'down_scale': random.uniform(0.5 / 2, 1)}
    distortion_degree3 = {'type_value': random.random(), 'l1_value': random.random(), 'l2_value': random.random(),
                         'angle_value': random.random(), 'shape_value': random.randint(8, 11),
                         'noise_std': random.uniform(8.0 / 255., 10.0 / 255.), 'jpeg_quality': random.randint(40, 60),
                         'rnum': np.random.rand(), 'up_scale': random.uniform(1, 2),
                         'down_scale': random.uniform(0.5 / 4, 1)}
    distortion_degree = [distortion_degree1, distortion_degree2, distortion_degree3][degree]
    distortion_probability = [1, 1, 1, 1] # [random.uniform(0, 1) for i in range(4)]
    ##
    ...
    for x in video_list:
        ...
        x3 = x3.convert("RGB")
        degraded.append(transfer_2(x3)*255)

        gt_L.append(GT_cv2*255)
