...
from VP_code.models.dynamic_convolutions import DynamicConvolution
...
class CAB(nn.Module):
    def __init__(self, num_feat, is_light_sr= False, compress_ratio=3,squeeze_factor=30):
        ...
        self.cab = nn.Sequential(
            ...
            DynamicConvolution(8, 2, in_channels=num_feat, out_channels=num_feat // compress_ratio, kernel_size=3, padding=1, temperature=1, bias=True),
            nn.GELU(),
            # nn.Conv2d(num_feat // compress_ratio, num_feat, 3, 1, 1),
            DynamicConvolution(8, 2, in_channels=num_feat // compress_ratio, out_channels=num_feat, kernel_size=3,
                               padding=1, temperature=1, bias=True),
